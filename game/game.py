...
def remove_punct(text):
    ...
    unedited_text = str.maketrans('', '', string.punctuation)
    removed_punct = text.translate(unedited_text)
...
def menu(exits):
    ...
    while True:
        ...
        # Normalise the input
        user_direction = normalise_input(user_direction)
        if is_valid_exit(exits, user_direction) == True:
